...
public class ElasticScrollView extends ScrollView {
	...
	public void addHead(){
		...
		headView = (LinearLayout) inflater.inflate(R.layout.refresh_head_layout,null);

		arrowImageView = (ImageView) headView.findViewById(R.id.imgvi_refreshHeadLayout_arrow);
		progressBar = (ProgressBar) headView.findViewById(R.id.probar_refreshHeadLayout);
		tipsTextview = (TextView) headView.findViewById(R.id.txvi_refreshHeadLayout_tips);
		lastUpdatedTextView = (TextView) headView.findViewById(R.id.txvi_refreshHeadLayout_lastUpdated);

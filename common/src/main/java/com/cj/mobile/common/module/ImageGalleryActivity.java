...
import com.cj.mobile.common.ui.ImagePreviewView;
import com.cj.mobile.common.ui.Loading;
...
//    @OnClick({R.id.iv_save})
    public void saveToFileByPermission(View view) {
            ...
            public void run() {
                try {
                    ...
                    if (sourceFile == null || !sourceFile.exists())
                        return;
                    String extension = ImageLoader.getExtension(sourceFile.getAbsolutePath());
                    String extDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)
                            .getAbsolutePath() + File.separator + "CJ";
                    ...
                    final boolean isSuccess = MobileUtil.copyFile(sourceFile, saveFile);
    ...
    private class ViewPagerAdapter extends PagerAdapter implements ImagePreviewView.OnReachBorderListener {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            // Do load
            if (mNeedCookie)
                loadImage(position, new GlideUrl(mImageSources[position]),
            ...
            getExecutor().execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        BitmapFactory.Options options = ImageLoader.createOptions();
                        ...
                        ImageLoader.resetOptions(options);

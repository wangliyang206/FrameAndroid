...
import com.cj.mobile.common.ui.adapter.AbViewPagerAdapter;
import com.cj.mobile.common.ui.topview.listener.AbOnChangeListener;
import com.cj.mobile.common.ui.topview.listener.AbOnItemClickListener;
import com.cj.mobile.common.ui.topview.listener.AbOnScrollListener;
import com.cj.mobile.common.ui.topview.listener.AbOnTouchListener;
...
//	private  final boolean D = AbAppData.DEBUG;
	...
	public void initView(Context context) {
		...
		//得到导航点的图片资源文件
		displayImage = BitmapFactory.decodeResource(getResources(),R.drawable.abs__list_activated_holo);
		hideImage =BitmapFactory.decodeResource(getResources(),R.drawable.abs__list_focused_holo);

...
public class MultiImageSelectorActivity extends AppCompatActivity implements MultiImageSelectorFragment.Callback {
    ...
    /**
     * 通过选择图像数据更新完成按钮 (Update done button by select image data)
    ...
    private void updateDoneText(ArrayList<String> resultList){
        ...
        mSubmitButton.setText(getString(R.string.mis_action_button_string, getString(R.string.mis_action_done), size, mDefaultCount));
    }

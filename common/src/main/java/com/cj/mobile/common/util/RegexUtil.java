...
public class RegexUtil {
     ...
     * @return
     */
    public static boolean checkContainsAlphabet(String input) {
        String regex = ".*[a-zA-Z]+.*";
     ...
     * @return
     */
    public static boolean checkContainsSpecialCharacters(String input) {
        String regex = "[`~!@#$%^&*()+=|{}':;',//[//].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]";
     ...
     * @return
     */
    public static boolean checkContainsChinese(String input) {
     ...
     * @return
     */
    public static boolean checkEnglish(String input) {
        String regex = "^[A-Za-z]+$";
        return Pattern.matches(regex, input);
    }

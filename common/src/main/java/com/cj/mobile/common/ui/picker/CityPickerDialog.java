 ...
 *
 */
public class CityPickerDialog extends AlertDialog implements OnClickListener{
	 ...
	 */
	public CityPickerDialog(Context context,TextView view) {
	 ...
	 * @param cpc			监听控件改变
	 */
	public CityPickerDialog(Context context,TextView view,Region region,CityPickerChangeView cpc) {
		super(context,R.style.dialog);
	...
	private void initView() {
		content = (CityPicker) findViewById(R.id.cipi_cityPickerDialog_content);
	...
	public void onClick(View v) {
		if(v.getId() == R.id.btn_cityPickerDialog_ok){
			if(view != null){
				...
				Timber.d("#1="+list.get(0)+"；#2="+list.get(1)+"；#3="+list.get(2)+"；");
				view.setTag(list);
			}
			if(this.cpc != null){
